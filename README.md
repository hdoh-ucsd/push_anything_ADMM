...
## Figure 8 — Current-Model Single Fixed Goal

The current-model smoke campaign ran seed 0 for up to 600 simulated seconds per
object with C3+ and `config/sampling_c3_kik_t.yaml`. All 23 tested objects
reached the tight SE(2) goal; Eraser and Gallon Milk were intentionally skipped.
Time to goal is the first fixed-goal latch at the 0.075 s planning interval.
