...
![System architecture: sampling, local LCS construction, C3/C3+ MPC, OSC, and PyDrake simulation](figures/system_architecture.svg)
...
See [EXPERIMENTS.md](EXPERIMENTS.md) for commands, measured outcomes,
artifacts, and reporting limitations.

## Current Research

![Research roadmap separating current implementation, active investigations, and planned work](figures/research_roadmap.svg)
...
![C3+ solver flow: local LCS, stacked QP, ADMM updates, and MPC action](figures/c3plus_solver_flow.svg)
