...
def main():
    ...
    while sim_time < max_time:
        ...
        # Tier-2 executor diagnostic (docs/conformance-map.md §1.d):
        # LOG-ONLY, env-gated PUSHA_EXEC_T2_DIAG=1. Checks whether the
        # plant sees an OVER-CAP torque because port clamps task-only u
