...
# Target: pusher center at (-0.075, 0, 0.05) — touching box's west face
# (box west face at x=-0.05, pusher radius 0.025 → center at x=-0.075)
target_xyz = np.array([-0.075, 0.0, 0.05])
