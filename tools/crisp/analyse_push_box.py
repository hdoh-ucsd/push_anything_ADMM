...
Reproduces the numbers quoted in control/crisp/README.md.
    ...
    python3 tools/crisp/analyse_push_box.py [cases|weights|barrier|hard|timing]
...
BENCH = dict(a=0.5, b=0.25, mu=0.3, mass=1.0, c_int=0.6)    # paper scale, 3 m targets
...
if __name__ == "__main__":
    cmds = {"cases": cmd_cases, "weights": cmd_weights, "barrier": cmd_barrier,
            "hard": cmd_hard, "timing": cmd_timing}
